...
date: 2022-12-19              #- ISO8601 YYYY-MM-DD format 
date-format: short
format: 
  revealjs:
    scrollable: true
    ...
    title-slide-attributes: #- atributos para la slide de titulo
      data-background-color: "#0ae7ff"   #- color de R-ladies
...
my_url <- "https://www.cepal.org/sites/default/files/news/images/poblacion.png?timestamp=1668449492"
...
#plotly::ggplotly(grafico_pastel_interactivo)

grafico_pastel_interactivo <- ggplotly(grafico_pastel_interactivo, tooltip = "text", dynamicTicks = TRUE, width = 2000, height = 1200)
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, results = TRUE}
my_url <- "https://img.freepik.com/vector-premium/bolsa-dinero-billetes-hucha-simbolo-riqueza-exito-buena-suerte-banca-finanzas-ilustracion-dibujos-animados-vector-plano-objetos-aislados-sobre-fondo-blanco_501569-73.jpg?w=2000"

```

![](https://img.freepik.com/vector-premium/bolsa-dinero-billetes-hucha-simbolo-riqueza-exito-buena-suerte-banca-finanzas-ilustracion-dibujos-animados-vector-plano-objetos-aislados-sobre-fondo-blanco_501569-73.jpg?w=2000)
...
p_interactivo <- ggplotly(p, tooltip = "text", dynamicTicks = TRUE, width = 1000, height = 600)
